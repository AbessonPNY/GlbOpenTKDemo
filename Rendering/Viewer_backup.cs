...
public class Viewer : GameWindow
{
    ...
    //private float _pitch = 0.0f;   // inclinaison haut/bas (en degrés)
    //private float _camDistance = 5.0f; // distance depuis l’origine (ajuste selon ton modèle)
    ...
    private string V3(Vector3 v) => $"({v.X:0.###}, {v.Y:0.###}, {v.Z:0.###})";
    ...
    // Viewer.cs
    //private float _modelYawDeg = 0f; // rotation du perso autour de l’axe Y
    ...
    protected override void OnLoad()
    {
        ...
        // Orientation : +90° sur la droite
        // (Ici on choisit X; si tu veux "à droite" autour de Y ou Z, change CreateRotationX par Y/Z)
        //var rot = Matrix4.CreateRotationX(MathHelper.DegreesToRadians(90f));
